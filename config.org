...
#+END_SRC
*** LSP
For some reason I'de been having an issue with loading ~lsp-ui~. I don't know why
this is needed, but it seems to fix things.
#+BEGIN_SRC emacs-lisp
(defvar lsp-ui-doc-winum-ignore nil)
#+END_SRC
Without this I get ~File mode specification error: (void-variable lsp-ui-doc-winum-ignore)~.
