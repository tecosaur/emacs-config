...
=xdg-desktop-portal= protocols, we can read this from D-Bus on most systems.
...
as an environment variable =DOOM_THEME= for fun.
...
#+begin_src emacs-lisp :tangle packages.el
(package! modus-themes :pin "d2762db19ed48bd0cbba61c41940be479760a35e")
#+end_src
...
good option.
#+begin_src emacs-lisp :tangle packages.el
(package! calibredb :pin "8ca1b5262f0f0e4a0e295efc2c14db00333e9a85")
#+end_src

Then for reading them, the only currently viable options seems to be [[https://depp.brause.cc/nov.el/][nov.el]].
#+begin_src emacs-lisp :tangle packages.el
(package! nov :pin "9b7bef950d68c2518710c480729d6bb6026e9489")
#+end_src
...
(package! org-transclusion :recipe (:host github :repo "nobiot/org-transclusion")
  :pin "b23ead229c651772c1406e052b9eff41fec71738")
#+end_src
